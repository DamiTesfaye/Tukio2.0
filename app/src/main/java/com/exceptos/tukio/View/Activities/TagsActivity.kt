...
import com.exceptos.tukio.Data.ViewModels.ProfileViewModel
...
import com.exceptos.tukio.databinding.ActivityTagsBinding
...
class TagsActivity : AppCompatActivity(), OnChipSelected, View.OnClickListener {
    ...
    lateinit var adapter: com.exceptos.tukio.Data.Adapters.TagsAdapter
            ...
            FireStoreRepo().getCurrentUserDocumentPath().get().addOnSuccessListener { snapshot ->
                if (snapshot != null && snapshot.exists()){
                    ...
                    if (userTags != null) {
                        ...
                        adapter = com.exceptos.tukio.Data.Adapters.TagsAdapter(chipList, this, userTags, this)
                        ...
                        adapter = com.exceptos.tukio.Data.Adapters.TagsAdapter(chipList, this, null, this)
