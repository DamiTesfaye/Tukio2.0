...
class PostedEventsActivity : AppCompatActivity(), OnShareEventClicked{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.posted_events_recycler)
        recyclerView.run{
            layoutManager = AppUtils.getRecycleLayout(AppUtils.LINEAR_LAYOUT_MANAGER, this@PostedEventsActivity)
        }
        ...
        findViewById<ImageButton>(R.id.close_posted_events_activity).setOnClickListener {
            onBackPressed()
        }
            ...
            .addSnapshotListener { snapshot, _ ->
                ...
                if (snapshot != null && !snapshot.isEmpty){
                    ...
                    for (document in snapshot.documents) {
                        ...
                        loading_posted_events.visibility = GONE
                    ...
                    loading_posted_events.visibility = GONE
                    posted_events_no_events.visibility = VISIBLE
